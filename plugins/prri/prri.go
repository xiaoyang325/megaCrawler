...
func init() {
	w := megaCrawler.Register("prri", "公共宗教研究所",
		"https://www.prri.org/")
	...
	// 从文章中获取Title并添加到ctx。
	w.OnHTML("div.researchArticleHeading__title", func(element *colly.HTMLElement, ctx *megaCrawler.Context) {
	...
	w.OnHTML(".researchArticleHeading__date", func(element *colly.HTMLElement, ctx *megaCrawler.Context) {
		ctx.PublicationTime = element.Text
	})

	w.OnHTML(".press__date", func(element *colly.HTMLElement, ctx *megaCrawler.Context) {
		ctx.PublicationTime = element.Text
	})
