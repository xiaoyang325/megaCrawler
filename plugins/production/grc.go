...
func init() {
	...
	w.OnHTML(`.gdlr-core-course-item-info > .gdlr-core-tail`, func(element *colly.HTMLElement, ctx *crawlers.Context) {
	...
	// 访问 Report 从 Index
	w.OnHTML(`.gdlr-core-head > a`, func(element *colly.HTMLElement, ctx *crawlers.Context) {
		w.Visit(element.Attr("href"), crawlers.Report)
	})

	// 获取 Title
	w.OnHTML(`[class="gdlr-core-title-item-title gdlr-core-skin-title "]`, func(element *colly.HTMLElement, ctx *crawlers.Context) {
		ctx.Title = strings.TrimSpace(element.Text)
	})

	// 获取 PublicationTime
	w.OnHTML(`.gdlr-core-pbf-element > div > span`, func(element *colly.HTMLElement, ctx *crawlers.Context) {
		ctx.PublicationTime = strings.TrimSpace(element.Text)
	})

	// 获取 CategoryText
	w.OnHTML(`h1.kingster-page-title`, func(element *colly.HTMLElement, ctx *crawlers.Context) {
		ctx.CategoryText = strings.TrimSpace(element.Text)
	})

	// 获取 Authors
	w.OnHTML(`.gdlr-core-pbf-element > div > .analysis_authors`, func(element *colly.HTMLElement, ctx *crawlers.Context) {
	...
	// 获取 Content
	w.OnHTML(`div.gdlr-core-text-box-item-content`, func(element *colly.HTMLElement, ctx *crawlers.Context) {
		ctx.Content = strings.TrimSpace(element.Text)
	})

	// 获取 File
	w.OnHTML(`a[class="gdlr-core-button  gdlr-core-button-solid gdlr-core-button-no-border"][target="_blank"]`, func(element *colly.HTMLElement, ctx *crawlers.Context) {
