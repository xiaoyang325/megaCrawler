...
func init() {
	w := Crawler.Register("clingendael", "国际关系研究所", "https://www.clingendael.org/")
	...
	// 从翻页器获取链接并访问
	w.OnHTML("a.show-more-results", func(element *colly.HTMLElement, ctx *Crawler.Context) {
		w.Visit(element.Attr("href"), Crawler.Index)
	})
	w.OnHTML("a.show-more-results", func(element *colly.HTMLElement, ctx *Crawler.Context) {
		w.Visit(element.Attr("href"), Crawler.Index)
	})
	w.OnHTML("a.link", func(element *colly.HTMLElement, ctx *Crawler.Context) {
		w.Visit(element.Attr("href"), Crawler.Index)
	})
	// 从index访问新闻
	w.OnHTML("h3.title", func(element *colly.HTMLElement, ctx *Crawler.Context) {
		w.Visit(element.Attr("href"), Crawler.News)
	})
	w.OnHTML("div.highlight-info>a", func(element *colly.HTMLElement, ctx *Crawler.Context) {
		w.Visit(element.Attr("href"), Crawler.News)
	})
	w.OnHTML("div.publication>a", func(element *colly.HTMLElement, ctx *Crawler.Context) {
		w.Visit(element.Attr("href"), Crawler.News)
	})
	w.OnHTML("div.node-info>a", func(element *colly.HTMLElement, ctx *Crawler.Context) {
		w.Visit(element.Attr("href"), Crawler.News)
	})
	// report.title
	...
	//report.publish time
	w.OnHTML("div.block-date", func(element *colly.HTMLElement, ctx *Crawler.Context) {
		ctx.PublicationTime = element.Text
	})
	// report.author
	w.OnHTML("div.staff-person-name>a", func(element *colly.HTMLElement, ctx *Crawler.Context) {
	...
	// report.category
	w.OnHTML("div.type-and-topic", func(element *colly.HTMLElement, ctx *Crawler.Context) {
		ctx.CategoryText = element.Text
	})

	// expert.Name
	w.OnHTML("div.expert-details>h1", func(element *colly.HTMLElement, ctx *Crawler.Context) {
		ctx.Name = element.Text
	})
	// expert.title
	w.OnHTML(".function", func(element *colly.HTMLElement, ctx *Crawler.Context) {
		ctx.Title = element.Text
	})
	// expert.description
	w.OnHTML("div.expert-info > div", func(element *colly.HTMLElement, ctx *Crawler.Context) {
		ctx.Content = element.Text
	})
	// expert.area
	w.OnHTML("div.expertise>ul>li", func(element *colly.HTMLElement, ctx *Crawler.Context) {
		ctx.Area = ctx.Area + "," + element.Text
	})
	// expert.link
	w.OnHTML("div.contact-icons>a", func(element *colly.HTMLElement, ctx *Crawler.Context) {
